...
$backend = Start-Process -FilePath "dotnet" -ArgumentList "run --project Backend --launch-profile Testing" -PassThru -WindowStyle Minimized
...
$blazor = Start-Process -FilePath "dotnet" -ArgumentList "run --project BlazorApp1" -PassThru -WindowStyle Minimized
